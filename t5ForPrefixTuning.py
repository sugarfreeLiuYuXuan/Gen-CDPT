...
PARALLELIZE_DOCSTRING = r"""
    This is an experimental feature and is apast_key_values = past_key_values.view subject to change at a moment's notice.
...
if __name__ == "__main__":
    # pre_seq_len, prefix_projection, hidden_size, num_hidden_layers, prefix_hidden_size

    configs = {"pre_seq_len":20,
               "hidden_size":768,
    ...
    # test t5
    model_name_or_path = '/data/liuyuxuan/model_cache/t5_base'
    tfm_model = MyT5ForConditionalGeneration.from_pretrained(model_name_or_path)